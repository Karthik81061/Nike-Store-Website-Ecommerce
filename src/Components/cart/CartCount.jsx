...
const CartCount = ({ onCartToggle, onClearCartItems }) => {
  return (
    <>
      <div
        className="bg-white h-11 flex items-center justify-between px-3
      ...
      >
        <div className="flex items-center accent-pink-300 gap-3">
          ...
          <div className="grid items-center">
            <h1 className="text-base font-nor,al text-slate-900">
              Your Cart{" "}
        ...
        <div className="flex items-center">
          ...
          >
            <XMarkIcon className="w-h h-5 text-white stroke-[2]" />
          </button>
        </div>
      </div>
    </>

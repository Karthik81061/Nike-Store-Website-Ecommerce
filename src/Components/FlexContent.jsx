    ...
    <>
      ...
      lg:justify-center nike-container ${ifExists ? 'flex-row-reverse':'flex-row'}`}>
        <div className='max-w-lg lg:max-w-none w-full md:text-center grid items-center md:justify-items-center'>
            ...
            <h1 className='text-5xl lg:text-4xl md:text-3xl sm:text-3xl font-bold
            ...
            <a href={url} className='flex items-center' target={"_blank"} role='button'>
                <button type='button' className='button-theme bg-slate-900 shadow-slate-900 text-slate-100 py1.5'>{btn}</button>
            </a>
        </div>
        <div className='flex items-center justify-center ma-w-xl lg:max-w-none w-full'>
